...
(defmethod handle-square-event-sc ((s square-event) timestamp &key)
  (if (> (event-reverb s) 0)     
      (osc:simple-bundle cm::*oscout* timestamp  
			 "/s_new"			 
			 "siiisfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsf"
			 "sqr_2ch_rev" -1 0 1
			 "freq" (coerce (if (typep (event-pitch s) 'symbol)
				    (cm::hertz (event-pitch s))
				    (event-pitch s)) 'float)
			 "freq_lfo_speed" (coerce (event-freq-lfo-speed s) 'float)
			 "freq_lfo_depth" (coerce (event-freq-lfo-depth s) 'float)
			 "freq_lfo_phase" (coerce (event-freq-lfo-phase s) 'float)
			 "gain" (coerce (event-level s) 'float)			 
			 "lp_freq" (coerce (event-lp-freq s) 'float)
			 "lp_q" (coerce (event-lp-q s) 'float)
			 "lp_dist" (coerce (event-lp-dist s) 'float)
			 "lp_freq_lfo_speed" (coerce (event-lp-lfo-speed s) 'float)
			 "lp_freq_lfo_depth" (coerce (event-lp-lfo-depth s) 'float)
			 "lp_freq_lfo_phase" (coerce (event-lp-lfo-phase s) 'float)
			 "hp_freq" (coerce (event-hp-freq s) 'float)
			 "hp_q" (coerce (event-hp-q s) 'float)
			 "hp_freq_lfo_speed" (coerce (event-hp-lfo-speed s) 'float)
			 "hp_freq_lfo_depth" (coerce (event-hp-lfo-depth s) 'float)
			 "hp_freq_lfo_phase" (coerce (event-hp-lfo-phase s) 'float)
			 "peak_freq" (coerce (event-pf-freq s) 'float)
			 "peak_q" (coerce (event-pf-q s) 'float)
			 "peak_gain" (coerce (event-pf-gain s) 'float)
			 "peak_freq_lfo_speed" (coerce (event-peak-lfo-speed s) 'float)
			 "peak_freq_lfo_depth" (coerce (event-peak-lfo-depth s) 'float)
			 "peak_freq_lfo_phase" (coerce (event-peak-lfo-phase s) 'float)
			 "peak_gain_lfo_speed" (coerce (event-peak-gain-lfo-speed s) 'float)
			 "peak_gain_lfo_depth" (coerce (event-peak-gain-lfo-depth s) 'float)
			 "peak_gain_lfo_phase" (coerce (event-peak-gain-lfo-phase s) 'float)
			 "a" (coerce (* (event-attack s) 0.001) 'float)
      ...
      (osc:simple-bundle cm::*oscout* timestamp
			 "/s_new"	    
			 "siiisfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsf"
			 "sqr_2ch" -1 0 1
			 "freq" (coerce (if (typep (event-pitch s) 'symbol)
				    (cm::hertz (event-pitch s))
				    (event-pitch s)) 'float)
